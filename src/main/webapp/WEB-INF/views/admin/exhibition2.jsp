...
<script>
	...
	let moveForm = $('#moveForm');
	   ...
	   function productOn()
	   {
		   ...
		   if(id!="")   
		      location="changeShow?chk=2&pShow=2&id="+id;
	   ...
	   function productOff()
	   {
		   ...
		   if(id!="")   
			   location="changeShow?chk=2&pShow=0&id="+id;
	...
	<div class="container-fluid">
		<div class="pb-3">
			<ul class="list-group list-group-horizontal pb-10">
			  <li class="list-group-item" onclick="location.href='exhibition'">
			  	New
			  </li>
			  <li class="list-group-item active" onclick="location.href='exhibition2'">
			  	Best
			  </li>
			</ul>
		</div>	
		...
		<div class="d-flex justify-content-between pb-2">
			...
			<form id="searchForm" action="exhibition2" method="get">
		...
		<table class="table">
			...
			<tr class="align-middle text-center">
				...
				<td>
					<c:if test="${pvo.pShow == 2}">베스트상품</c:if>
					<c:if test="${pvo.pShow != 2}">일반상품</c:if>					
				</td>
				<td>${pvo.pCode }</td>
		...
		<form id="moveForm" action="exhibition2" method="get" >
